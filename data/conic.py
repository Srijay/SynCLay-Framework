...
from preprocessing.conic.delaunay_triangulation import delaunay_scene_graph
...
class CoNiCDataset(Dataset):
    ...
    def __init__(self, image_dir, mask_dir, label_dir, image_size=(256, 256), object_mask_size=(32,32),
        ...
        self.vocab = {"neutrophil": 0, "epithelial": 1, "lymphocyte": 2, "plasma": 3, "eosinophil": 4 , "connectivetissue": 5}
    ...
    def __getitem__(self, index):
        ...
        return image_name, image_t, color_mask_t, label_t, object_indices, object_coordinates, object_bounding_boxes, object_bounding_boxes_constructed, object_masks, object_embeddings, triples, class_vectors



def conic_collate_fn(batch):
  """
  Collate function to be used when wrapping CoNiC dataset in a
  ...
  if(batch[0]==None):
      return [[]]*11 #number of output values

  image_t_l = []
  mask_t_l = []
  label_t_l = []
  for i, (image_name, image_t, mask_t, label_t, object_indices, object_coordinates, object_bounding_boxes, object_bounding_boxes_constructed, object_masks, object_embeddings, triples, class_vectors) in enumerate(batch):
  ...
  out = (image_name, image_t_l, mask_t_l, label_t_l, object_indices_l, object_coordinates_l, object_bounding_boxes_l, object_bounding_boxes_constructed_l, object_masks_l, object_embeddings_l, triples_l, class_vectors_l)
